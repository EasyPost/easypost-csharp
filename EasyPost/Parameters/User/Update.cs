...
{
    /// <summary>
    ///     <a href="https://docs.easypost.com/docs/users#update-a-user">Parameters</a> for <see cref="EasyPost.Services.UserService.Update(string, Update, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
