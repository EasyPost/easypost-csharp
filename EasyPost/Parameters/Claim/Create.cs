...
{
    /// <summary>
    ///     <a href="https://www.easypost.com/docs/api#create-an-insurance">Parameters</a> for <see cref="EasyPost.Services.ClaimService.Create(Create, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
