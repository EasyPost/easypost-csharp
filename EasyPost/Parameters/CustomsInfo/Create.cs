...
{
    /// <summary>
    ///     <a href="https://docs.easypost.com/docs/customs-infos#create-a-customsinfo">Parameters</a> for <see cref="EasyPost.Services.CustomsInfoService.Create(Create, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
    ...
    public class Create : BaseParameters<Models.API.CustomsInfo>, ICustomsInfoParameter
    {
        ...
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "contents_explanation")]
        ...
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "contents_type")]
        ...
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "customs_certify")]
        public bool? CustomsCertify { get; set; }

        /// <summary>
        ///     List of <see cref="Models.API.CustomsItem"/>s (or <see cref="CustomsItem.Create"/> parameters) being shipped.
        /// </summary>
        [TopLevelRequestParameter(Necessity.Optional, "customs_info", "customs_items")]
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "customs_items")]
        ...
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "customs_signer")]
        ...
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "declaration")]
        ...
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "eel_pfc")]
        ...
        [NestedRequestParameter(typeof(Shipment.Create), Necessity.Optional, "non_delivery_option")]
