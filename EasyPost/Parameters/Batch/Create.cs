...
{
    /// <summary>
    ///     <a href="https://docs.easypost.com/docs/batches#create-a-batch">Parameters</a> for <see cref="EasyPost.Services.BatchService.Create(Create, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
