...
{
    /// <summary>
    ///     <a href="https://docs.easypost.com/docs/batches#remove-shipments-from-a-batch">Parameters</a> for <see cref="EasyPost.Services.BatchService.RemoveShipments(string, RemoveShipments, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
