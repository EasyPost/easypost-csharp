...
namespace EasyPost.Parameters.Event
{
    /// <summary>
    ///     <a href="https://docs.easypost.com/docs/events#retrieve-all-events">Parameters</a> for <see cref="EasyPost.Services.EventService.All(All, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
