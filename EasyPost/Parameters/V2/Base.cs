...
#pragma warning restore SA1649
    ...
    /// <summary>
    ///     Base class for all parameters used in "create" requests to <see cref="ApiVersion.V2"/> endpoints.
    /// </summary>
    ...
    /// <summary>
    ///     Base class for all parameters used in "update" requests to <see cref="ApiVersion.V2"/> endpoints.
    /// </summary>
    ...
    /// <summary>
    ///     Base class for all parameters used in "list" requests to <see cref="ApiVersion.V2"/> endpoints.
    /// </summary>
