...
{
    /// <summary>
    ///     <a href="https://docs.easypost.com/docs/luma#one-call-buy">Parameters</a> for <see cref="EasyPost.Services.LumaService.GetPromise(GetPromise, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class GetPromise : BaseParameters<Models.API.Shipment>
    {
