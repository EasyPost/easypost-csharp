...
{
    /// <summary>
    ///     <a href="https://docs.easypost.com/docs/trackers">Parameters</a> for <see cref="EasyPost.Services.TrackerService.RetrieveBatch(Batch, System.Threading.CancellationToken)"/> API calls.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class Batch : BaseAllParameters<Models.API.Tracker>
    {
        ...
        /// <returns>An <see cref="Batch"/> parameters set.</returns>
        public static new Batch FromDictionary(Dictionary<string, object>? dictionary)
        {
            if (dictionary == null) return new Batch();
            return new Batch
            {
