...
namespace EasyPost._base
{
    public abstract class EasyPostService : WithClient, IEasyPostService
    {
        ...
        protected async Task CreateBlind(string url, Dictionary<string, object?>? parameters = null, ApiVersion? apiVersion = null) => await Request(Method.Post, url, parameters, apiVersion);
        ...
        protected async Task DeleteBlind(string url, Dictionary<string, object?>? parameters = null, ApiVersion? apiVersion = null) => await Request(Method.Delete, url, parameters, apiVersion);
        ...
        protected async Task UpdateBlind(string url, Dictionary<string, object?>? parameters = null, ApiVersion? apiVersion = null) => await Request(Method.Patch, url, parameters, apiVersion);
    }
