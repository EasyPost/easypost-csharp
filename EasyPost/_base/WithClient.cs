...
#pragma warning restore SA1300
{
    public abstract class WithClient
    {
        ...
        protected async Task<T> Request<T>(Method method, string url, Dictionary<string, object>? parameters = null, string? rootElement = null, ApiVersion? overrideApiVersion = null)
            where T : class
            => await Client!.Request<T>(method, url, overrideApiVersion ?? ApiVersion.Current, parameters, rootElement);
