...
{
    public class VcrError : ApiError
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="VcrError" /> class.
        /// </summary>
        ...
        internal VcrError(string errorMessage, int statusCode, string? errorType = null, List<Error>? errors = null) : base(errorMessage, statusCode, errorType, errors)
        {
        }
    }
}
