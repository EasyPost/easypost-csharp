...
public class RetryError : ApiError
{
    ...
    internal RetryError(string errorMessage, int statusCode, string? errorType = null, List<Error>? errors = null) : base(errorMessage, statusCode, errorType, errors) => throw new NotImplementedException();
}
