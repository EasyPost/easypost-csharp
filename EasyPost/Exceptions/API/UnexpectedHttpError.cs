...
public class UnexpectedHttpError : ApiError
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="UnexpectedHttpError" /> class.
    /// </summary>
    ...
    internal UnexpectedHttpError(string errorMessage, int statusCode, string? errorType = null, List<Error>? errors = null) : base(errorMessage, statusCode, errorType, errors)
    {
    }
}
