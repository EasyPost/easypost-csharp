...
public class ServiceUnavailableError : ApiError
{
    ...
    internal ServiceUnavailableError(string errorMessage, int statusCode, string? errorType = null, List<Error>? errors = null) : base(errorMessage, statusCode, errorType, errors)
    {
    }
}
