...
public class GatewayTimeoutError : ApiError
{
    ...
    internal GatewayTimeoutError(string errorMessage, int statusCode, string? errorType = null, List<Error>? errors = null) : base(errorMessage, statusCode, errorType, errors)
    {
    }
}
