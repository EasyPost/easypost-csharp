...
namespace EasyPost.Exceptions
{
    public class ExternalApiError : ApiError
    {
        ...
        internal ExternalApiError(int statusCode, string errorMessage, string? errorType = null, List<Error>? errors = null) : base(statusCode, errorMessage, errorType, errors)
        {
        }
    }
}
