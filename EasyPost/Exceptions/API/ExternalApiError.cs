...
namespace EasyPost.Exceptions.API
{
    public class ExternalApiError : ApiError
    {
        ...
        internal ExternalApiError(string errorMessage, int statusCode, string? errorType = null, List<Error>? errors = null) : base(errorMessage, statusCode, errorType, errors)
        {
        }
    }
}
