...
namespace EasyPost.Exceptions
{
    public class UnauthorizedError : ApiError
    {
        ...
        internal UnauthorizedError(int statusCode, string errorMessage, string? errorType = null, List<Error>? errors = null) : base(statusCode, errorMessage, errorType, errors)
        {
        }
    }
}
