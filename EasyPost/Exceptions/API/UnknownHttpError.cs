...
namespace EasyPost.Exceptions.API
{
    public class UnknownHttpError : ApiError
    {
        ...
        internal UnknownHttpError(string errorMessage, int statusCode, string? errorType = null, List<Error>? errors = null) : base(errorMessage, statusCode, errorType, errors)
        {
        }
    }
}
