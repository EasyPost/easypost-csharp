...
namespace EasyPost.Models.API
{
    public class Shipment : EasyPostObject, IShipmentParameter
    {
        ...
        public async Task Buy(string? rateId, string? insuranceValue = null, bool withCarbonOffset = false, string? endShipperId = null)
        {
            ...
            await Request<Shipment>(Http.Method.Post, $"shipments/{Id}/buy", parameters);
        }
        ...
        public async Task<Shipment> Buy(BetaFeatures.Parameters.Shipments.Buy parameters)
        {
            ...
            await Request<Shipment>(Http.Method.Post, $"shipments/{Id}/buy", parameters.ToDictionary());
            return this;
        }
        ...
        public async Task<Shipment> GenerateLabel(string fileFormat)
        {
            ...
            await Request<Shipment>(Http.Method.Get, $"shipments/{Id}/label", parameters);
            return this;
        }
        ...
        public async Task<Shipment> GenerateLabel(BetaFeatures.Parameters.Shipments.GenerateLabel parameters)
        {
            ...
            await Request<Shipment>(Http.Method.Get, $"shipments/{Id}/label", parameters.ToDictionary());
            return this;
        }
        ...
        public async Task<Shipment> Insure(double amount)
        {
            ...
            await Request<Shipment>(Http.Method.Post, $"shipments/{Id}/insure", parameters);
            return this;
        }
        ...
        public async Task<Shipment> Insure(BetaFeatures.Parameters.Shipments.Insure parameters)
        {
            ...
            await Request<Shipment>(Http.Method.Post, $"shipments/{Id}/insure", parameters.ToDictionary());
            return this;
        }
        ...
        public async Task<Shipment> Refund()
        {
            ...
            await Request<Shipment>(Http.Method.Post, $"shipments/{Id}/refund");
            return this;
        }
