...
namespace EasyPost.Models.API
{
    public class CarrierAccount : EasyPostObject, ICarrierAccountParameter
    {
        ...
        public async Task<CarrierAccount> Update(Dictionary<string, object> parameters)
        {
            ...
            await Request<CarrierAccount>(Http.Method.Patch, $"carrier_accounts/{Id}", parameters);
            return this;
        }
        ...
        {
            await Request<CarrierAccount>(Http.Method.Patch, $"carrier_accounts/{Id}", parameters.ToDictionary());
            return this;
        }
