...
namespace EasyPost.Models.API
{
    public class Pickup : EasyPostObject, IPickupParameter
    {
        ...
        public async Task<Pickup> Buy(string withCarrier, string withService)
        {
            ...
            await Request<Pickup>(Http.Method.Post, $"pickups/{Id}/buy", parameters);
            return this;
        }
        ...
        public async Task<Pickup> Buy(BetaFeatures.Parameters.Pickups.Buy parameters)
        {
            ...
            await Request<Pickup>(Http.Method.Post, $"pickups/{Id}/buy", parameters.ToDictionary());
            return this;
        }
        ...
        public async Task<Pickup> Cancel()
        {
            ...
            await Request<Pickup>(Http.Method.Post, $"pickups/{Id}/cancel");
            return this;
        }
