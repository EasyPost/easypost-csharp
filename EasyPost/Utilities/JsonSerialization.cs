...
namespace EasyPost.Utilities
{
    ...
    public class JsonSerializer
    {
        ...
        ///     built-in settings.
        /// </param>
        public JsonSerializer(JsonSerializerSettings? jsonSerializerSettings = null) => JsonSerializerSettings = jsonSerializerSettings ?? JsonSerialization.DefaultJsonSerializerSettings;
    ...
    public static class JsonSerialization
    {
        ...
        /// <returns>A T-type object</returns>
        public static T GetValueOfJsonObjectKey<T>(JObject obj, string key) => obj.TryGetValue(key, out JToken? value) ? value.ToObject<T>() : default;
