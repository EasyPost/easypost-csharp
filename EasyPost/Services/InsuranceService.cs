...
namespace EasyPost.Services
{
    public class InsuranceService : EasyPostService
    {
        ...
        [ApiCompatibility(ApiVersion.Latest)]
        public async Task<Models.API.Insurance> Create(Parameters.Insurance.Create parameters)
        {
            return await Create<Models.API.Insurance>("insurances", parameters);
        }
        ...
        /// <returns>EasyPost.Insurance instance.</returns>
        [ApiCompatibility(ApiVersion.Latest)]
        public async Task<Models.API.Insurance> Retrieve(string id)
        {
            return await Get<Models.API.Insurance>($"insurances/{id}");
        }
    }
}
