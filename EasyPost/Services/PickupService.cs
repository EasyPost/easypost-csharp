...
public class PickupService : EasyPostService
{
    ...
    /// </summary>
    [CrudOperations.Update]
    public async Task<Pickup> Cancel(string id) => await Request<Pickup>(Method.Post, $"pickups/{id}/cancel");
    ...
    public PickupRate LowestRate(IEnumerable<Rate> rates, List<string>? includeCarriers = null, List<string>? includeServices = null, List<string>? excludeCarriers = null, List<string>? excludeServices = null) => (PickupRate)Calculation.Rates.GetLowestObjectRate(rates, includeCarriers, includeServices, excludeCarriers, excludeServices);
