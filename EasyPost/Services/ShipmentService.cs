...
public class ShipmentService : EasyPostService
{
    ...
    [CrudOperations.Read]
    public async Task<ShipmentCollection> All(Dictionary<string, object>? parameters = null) => await Request<ShipmentCollection>(Method.Get, "shipments", parameters);
    ...
    [CrudOperations.Read]
    public async Task<List<Smartrate>> GetSmartrates(string id) => await Request<List<Smartrate>>(Method.Get, $"shipments/{id}/smartrate", null, "result");
    ...
    /// </summary>
    [CrudOperations.Update]
    public async Task<Shipment> Refund(string id) => await Request<Shipment>(Method.Post, $"shipments/{id}/refund");
    ...
    public Rate GetLowestRate(Shipment shipment, List<string>? includeCarriers = null, List<string>? includeServices = null, List<string>? excludeCarriers = null, List<string>? excludeServices = null)
    {
        ...
        return Rates.GetLowestObjectRate(shipment.Rates, includeCarriers, includeServices, excludeCarriers, excludeServices);
    }
    ...
    public Smartrate GetLowestSmartrate(IEnumerable<Smartrate> smartrates, int deliveryDays, SmartrateAccuracy deliveryAccuracy) => Rates.GetLowestShipmentSmartrate(smartrates, deliveryDays, deliveryAccuracy);
}
