...
namespace EasyPost.Tests
{
    ...
    public class ShipmentTest
    {
        ...
        public static async Task<Shipment> CreateBasicShipment() => await Shipment.Create(Fixture.BasicShipment);

        public static async Task<Shipment> CreateFullShipment() => await Shipment.Create(Fixture.FullShipment);

        public static async Task<Shipment> CreateOneCallBuyShipment() => await Shipment.Create(Fixture.OneCallBuyShipment);
    }
}
