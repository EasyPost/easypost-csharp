...
namespace EasyPost.Tests
{
    public static class Fixture
    {
        ...
        public static Dictionary<string, object> BasicCustomsInfo => new Dictionary<string, object>
        {
            ...
            { "customs_items", new List<object> { BasicCustomsItem } }
        };
        ...
        public static Dictionary<string, object> BasicOrder => new Dictionary<string, object>
        {
            ...
            { "from_address", BasicAddress },
            { "shipments", new List<Dictionary<string, object>> { BasicShipment } }
        };
        ...
        public static string Event
        {
            get
            {
                Dictionary<string, object?> data = new Dictionary<string, object?>
                {
                    ...
                    { "previous_attributes", new Dictionary<string, object> { { "state", "purchasing" } } },
                    { "pending_urls", new List<string> { "example.com/easypost-webhook" } },
