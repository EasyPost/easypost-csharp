...
using EasyPost.Parameters.CustomsItems;
...
namespace EasyPost.Tests.ServicesTests.WithParameters
{
    ...
    {
        public CustomsItemServiceTests() : base("customs_item_service_with_parameters")
        {
        }
        ...
        public async Task TestCreate()
        {
            ...
            Create parameters = Fixtures.Parameters.CustomsItems.Create(data);
