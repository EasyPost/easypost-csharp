...
namespace EasyPost.Tests.BetaFeaturesTests.ServicesTests
{
    public class AddressServiceTests : UnitTest
    {
        ...
        public async Task TestCreate()
        {
            ...
            BetaFeatures.Parameters.Addresses.Create parameters = Fixtures.Parameters.Addresses.Create(fixture);
        ...
        public async Task TestAll()
        {
            ...
            BetaFeatures.Parameters.Addresses.All parameters = Fixtures.Parameters.Addresses.All(fixture);
